...
class FishControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fish" do
    assert_difference('Fish.count') do
      post fish_index_url, params: { fish: { description: @fish.description, name: @fish.name, price: @fish.price, user_id: @fish.user_id } }
    end
  ...
  test "should update fish" do
    patch fish_url(@fish), params: { fish: { description: @fish.description, name: @fish.name, price: @fish.price, user_id: @fish.user_id } }
